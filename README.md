...
![Dashboard Preview](assets/screenshots/dashboard.png) <!-- REPLACE WITH ACTUAL SCREENSHOT PATH -->
...
![Dashboard](assets/screenshots/dashboard.png) <!-- EXAMPLE: Replace with actual path -->
